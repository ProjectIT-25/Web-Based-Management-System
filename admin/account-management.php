...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container-fluid mt-4">
            ...
            <table class="table sortable table-responsive-md table-bordered bg-white rounded shadow-sm  table-striped text-center mt-4" id="accountstbl">
                ...
                <tbody>
                    ...
                    $result = mysqli_query($connections, "SELECT * FROM accountstbl LIMIT $start_from, $limit");
                    ...
                    if ($result) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <td><a  href="update-account.php?id='.$id.'"><button class="btn btn-success">Update</button></a>
                            <a onclick="javascript:confirmationDelete($(this));return false;" href="deleteaccount.php?deleteid='.$id.'""><button class="btn btn-danger">Delete</button></a>
                            </td>
                            </tr> ';
                        }
                    }
                    ...
                    <script type="text/javascript">
                        function confirmationDelete(anchor)
                        {
                            ...
                            var conf = confirm("Are you sure want to delete "+name+"'s account?");
                            if(conf)
            ...
            <div class="page d-flex justify-content-around"> <!-- PAGINATION -->
                <?php

                $result_db = mysqli_query($connections,"SELECT COUNT(*) FROM accountstbl"); 
                ...
                for ($i=1; $i<=$total_pages; $i++) {
                  $pagLink .= "<li class='page-item'><a class='page-link' href='account-management.php?page=".$i."'>".$i."</a></li>";   
              }
              echo $pagLink . "</ul>";  
    ...
    <script>
        function searchFilter() {
            ...
            table = document.getElementById("accountstbl");
