  ...
  $body = [
    'Messages' => [
      [
        ...
        'TextPart' => "Dear $fname,",
        'HTMLPart' => "<h2>Dear $fname,<br>You have been accepted to <a href='https://document-management-systems.herokuapp.com/'>MCC</a>!</h2><h3>Here is your login credentials:</h3><h4>Email: $email<br>Password: <i>$password</i></h4>"
      ]
    ]
  ];
